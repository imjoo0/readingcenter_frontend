...
// GraphQL 요청을 보내는 함수
export const refreshToken = async (refreshToken) => {  // refreshToken 인자 추가
  try {
    ...
    // GraphQL 요청 실행
    const data = await graphqlClient.request(REFRESH_TOKEN_QUERY, { refreshToken });  // refreshToken 인자 전달
