          ...
          >
            ...
            >
              ...
              <S.InputInput
                ...
                placeholder="제목, 작가, PLBN으로 검색해주세요."
              ></S.InputInput>
            </div>
          </div>
          {isLoading ? <Spin></Spin> : <></>}
        ...
        >
          <div>
            ...
            <div>
              ...
              ></Switch>
              <span>
                {isNotificationCustom ? "등원 시간 기준" : "수업 시간 기준"}
              </span>
            </div>
            <div>
              <button onClick={onClickSetting}>저장</button>
              <button
                onClick={() => {
                  setIsSetting(false);
                  setIsNotificationCustom(
